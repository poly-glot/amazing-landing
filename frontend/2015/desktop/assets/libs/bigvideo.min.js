    ...
    $.BigVideo = function(options) {
        ...
        BigVideo.init = function() {
            if (!isInitialized) {
                ...
                player = $('<video id="'+vidEl.substr(1)+'" class="video-js vjs-default-skin" height="1" width="1" preload="auto" poster="' + window.baseurl + 'assets/video/Yellow-Long-1.jpg" autoplay data-setup="{}" '+autoPlayString+' webkit-playsinline></video>');
