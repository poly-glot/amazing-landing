 ...
 *
 * Layout: helper → raw data (age → skin → concern → product → priority)
 *       → public API at the bottom, closest to export.
 */
...
/**
 * Map several age-bracket keys to the same data object.
 * Reduces the repetition that dominated the original file.
 */
